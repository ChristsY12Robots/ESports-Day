...
class game ():
        ...
        def defaulthiscorelist(self):
                return [ (100000,"Miles") , (80000,"Thowhid") , (60000,"Nathan") , (40000,"Mr Raisin") , (20000,"Charles Babbage") , (10000,"David") ]
        ...
        def gethiscores(self):
                ...
                try:
                  f=open(os.path.join(SCRIPT_PATH,"res","BROKENhiscore.txt"))
                  hs=[]
                  for line in f:
