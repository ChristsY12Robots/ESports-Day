...
def run():
    '''
    spec = importlib.util.spec_from_file_location("main.py", "./main.py")
...
def space_invaders():
    ...
    reciever('Space_Invaders')
    
    '''spec = importlib.util.spec_from_file_location("Space_Invaders.py", "./Space_Invaders.py")
    foo = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(foo)
    foo.MyClass()
    subprocess.call('Space_Invaders.py', shell = True)'''
...
def snake():
    '''
    spec = importlib.util.spec_from_file_location("snake.py", "./snake.py")
    foo = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(foo)
    foo.MyClass()
    '''
